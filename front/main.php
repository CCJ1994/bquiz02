...
<div style="width:98%;margin:auto;">
  <div class="tag active" data-tag="1">健康新知</div><div class="tag" data-tag="2">菸害防治</div><div class="tag" data-tag="3">癌症防治</div><div class="tag" data-tag="4">慢性病防治</div>
  <div class="post" id="p1" style="display:block;">
  <h4>健康新知</h4>
  <pre>
