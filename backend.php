...
<body>
  ...
  <div id="all">
    <div id="title">
      <?=date(" m 月 d 號 l");?> | 今日瀏覽: <?=$Total->find(['date'=>date("Y-m-d")])['total'];?> | 累積瀏覽: <?=$Total->q("select sum(`total`) from `total`")[0][0];?> <span style="float:right;"><a href="index.php">回首頁</a></span></div>
    ...
    <div id="mm">
      ...
      <div class="hal" id="main">
        <div>
          ...
          <marquee behavior="" direction="">請民眾踴躍投稿電子報，讓電子報成為大家相互交流、分享的園地!</marquee>
          </span>
